  ...
  return (
    <div className="grid grid-cols-2 gap-5 p-10">
      <div className="border bg-white border-borderLight rounded-medium p-5 shadow-md flex flex-col gap-8">
        ...
        <button className="p-3 bg-linear-60 from-primary to-compAdmin font-semibold text-white rounded-medium self-end">
          Uložit
        </button>
      </div>
      <div className="border bg-white border-borderLight rounded-medium p-5 shadow-md flex gap-8 col-start-1 justify-between items-center">
        ...
        <button className="p-3 bg-linear-60 from-primary to-compAdmin font-semibold text-white rounded-medium ">
